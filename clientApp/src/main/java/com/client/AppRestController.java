...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://mkaveesha.auth0.com/authorize"+
                    "?audience=https://mkaveesha.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=7uaAxBIDNsvNARptZHHvm0UJPRAGn0qa"+
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=7uaAxBIDNsvNARptZHHvm0UJPRAGn0qa"+
                            "&client_secret=hMeqn3B0jiVa3Veky7U4aTKdbKB9KgenPBn30cmvLwp8Z1l8GYB5wD-s7M5uRnfa"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2F%2Flocalhost%3A8888%2Foauth%2Faccess";
        String authReponse = "";
